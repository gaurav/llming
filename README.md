...
A directory to store small scripts dreamt up by LLMs, plus the coding agent skills in `skills/` and
the tool settings in `settings/` that are shared across machines. See CLAUDE.md for the
conventions each follows, and `skills/README.md` for what each skill is for.
